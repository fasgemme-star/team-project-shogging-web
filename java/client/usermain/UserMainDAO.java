...
public class UserMainDAO {
    ...
    public List<ProductDTO> selectBest(){
        ...
        try {
            ...
            String sql = " SELECT pi.url, p.PRODUCT_ID, po.OPTION_ID, "
                       ...
                       + " GROUP BY pi.URL, p.PRODUCT_ID,po.OPTION_ID, p.PRODUCT_NAME, p.SHORTINFO, po.DISCOUNT, po.OPTION_NAME, po.PRICE "
    ...
    public List<ProductDTO> selectCategory(RangeDTO range) {
        ...
        try {
            ...
            String sql = " SELECT * "
                       ...
                       + "   SELECT A.*, ROWNUM RN "
                       + "   FROM ( "
                       + "     SELECT p.PRODUCT_ID, po.OPTION_ID, p.PRODUCT_NAME, po.OPTION_NAME, p.SHORTINFO, po.PRICE, po.DISCOUNT, pi.URL "
                       + "     FROM PRODUCT p "
                       + "     INNER JOIN PRODUCT_OPTION po ON p.PRODUCT_ID = po.PRODUCT_ID "
                       + "     INNER JOIN CATEGORY c ON p.CATEGORY_ID = c.CATEGORY_ID "
                       + "     LEFT JOIN PRODUCT_IMAGE pi ON p.PRODUCT_ID = pi.PRODUCT_ID AND pi.IMAGE_TYPE='THUMB' "
