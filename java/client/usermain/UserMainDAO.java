    ...
    public List<ProductDTO> selectBest(){
        ...
        try {
            ...
            String sql = " SELECT pi.url, po.OPTION_ID, "
                       ...
                       + " GROUP BY pi.url, po.OPTION_ID, p.PRODUCT_NAME, p.SHORTINFO, po.DISCOUNT, po.OPTION_NAME, po.PRICE "
    ...
    public List<ProductDTO> selectCategory(RangeDTO range) {
        ...
        try {
            ...
            String sql = " SELECT * "
                       ...
                       + "   SELECT A.*, ROWNUM RN "
                       + "   FROM ( "
                       + "     SELECT po.OPTION_ID, p.PRODUCT_NAME, po.OPTION_NAME, p.SHORTINFO, po.PRICE, po.DISCOUNT, pi.URL "
                       + "     FROM PRODUCT p "
                       + "     INNER JOIN PRODUCT_OPTION po ON p.PRODUCT_ID = po.PRODUCT_ID "
