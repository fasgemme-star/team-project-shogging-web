...
<footer class="bg-surface-container mt-20">
  <div class="w-full py-margin-mobile px-margin-desktop flex flex-col md:flex-row justify-between items-center gap-gutter-md max-w-max-width mx-auto">
    ...
    <div class="flex gap-gutter-sm">
      <a class="text-on-surface-variant hover:text-on-surface transition-colors text-body-sm" href="${pageContext.request.contextPath}/about.jsp">회사소개</a>
      <a class="text-on-surface-variant hover:text-on-surface transition-colors text-body-sm" href="${pageContext.request.contextPath}/terms.jsp">이용약관</a>
